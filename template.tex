...
\begin{document}
    ...
    \whiteFrame{Sobre o Departamento}{
    ...
    \whiteFrame{Frame sem Tópicos}{
        \lipsum[10]
    }
    
    \blueFrame{Frame sem Tópicos}{
        \lipsum[10]
    }
    
    \blueCampusFrame{Frame sem Tópicos}{
        \lipsum[10]
    }
    % \frame{
    ...
    \whiteCampusFrame{}{
        \Large{Exemplo de texto grande pra um slide de impacto com algo bastante \colorbox{orangede}{\destacado{white}{destacado}}}
    }
